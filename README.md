...
- **AI Providers**: Google Gemini (`@google/generative-ai`) e Anthropic Claude (`@anthropic-ai/sdk`)
...
| :--- | :--- | :--- | :--- |
| **`POST`** | `/genai/tutor/chat` | `aluno`, `professor` | Conversa com o tutor Fox com janela deslizante de 6 mensagens. |
